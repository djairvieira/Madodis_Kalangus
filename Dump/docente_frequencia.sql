...
CREATE TABLE `frequencia` (
  ...
  PRIMARY KEY (`ID`),
  KEY `FK9B871095B3B7C8BC` (`aula_ID`),
  CONSTRAINT `FK9B871095B3B7C8BC` FOREIGN KEY (`aula_ID`) REFERENCES `tb_aula` (`ID`)
...
INSERT INTO `frequencia` VALUES (1,1),(2,2),(3,3),(4,5),(5,6);
