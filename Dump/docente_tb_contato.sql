...
CREATE TABLE `tb_contato` (
  ...
  PRIMARY KEY (`ID`),
  KEY `FK51D0153959D3F41C` (`telefone_ID`),
  KEY `FK51D015396D696C58` (`instituicao_ID`),
  CONSTRAINT `FK51D0153959D3F41C` FOREIGN KEY (`telefone_ID`) REFERENCES `tb_telefone` (`ID`),
  CONSTRAINT `FK51D015396D696C58` FOREIGN KEY (`instituicao_ID`) REFERENCES `tb_instituicao` (`ID`)
